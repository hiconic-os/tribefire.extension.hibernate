...
The key is also available as `Environment.ID_DB_STRUCTURE_NAMING_STRATEGY` in `Hibernate`.

**NOTE:**
If you configure version 1 of the mappings, this property is set automatically (both `Cortex` and `Reflex`).